<form role="form" id="edit-form" autocomplete="off" enctype="multipart/form-data" class="form-material" method="post"  action="{{ route('admin.feeOffer.update', ['feeOffer' => $feeOffer->id]) }}" enctype="multipart/form-data">
    ...
    <div class="modal-body">
        <div class="row">
            ...
            <div class="col-sm-3">
                <div class="form-group form-default">
                    <input type="text" name="start_date" class="form-control start-datepicker" value="{{ $feeOffer->start_date }}" required>
                    <span class="form-bar"></span>
            ...
            <div class="col-sm-3">
                <div class="form-group form-default">
                    <input type="text" name="end_date" class="form-control end-datepicker" value="{{ $feeOffer->end_date }}" required>
                    <span class="form-bar"></span>
