...
<div class="card">
	<div class="card-header">
		<h5>{{ $name }}</h5>
		<button type="button" data-url="{{ route('admin.academicYear.create') }}" class="btn btn-primary waves-effect float-right" id="add-form-btn">Add Finacial Year</button>
	</div>
...
<script>
	$(function() {
		$('#users-table').DataTable({
			...
			ajax: '{{ route("admin.academicYear.userdata") }}',
			columns: [{
					data: 'id',
					name: 'id',
					class: 'd-none',
